 ...
 * The reason to this is to reduce Singleton accesses and therefore a better and cleaner code.
 * 
 * */

[CreateAssetMenu(menuName = "ScriptableObject/IntVariable", fileName = "new IntVariable")]
